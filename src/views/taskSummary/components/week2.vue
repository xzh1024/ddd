    ...
    export default {
                ...
                tableData:[
                    {
                        ...
                        "schedule_start_time_unix": 1599148800,
                        "schedule_end_time_unix": 1600185599,
                        "start_time_unix": 1599198213,
                        "end_time_unix": 1600185599,
                        "cp_admin_name": "饶饶乙方",
                        "cp_admin_id": 20002,
                        "cp_id": 32,
                        "cp_name": "怡宝",
                        ...
                        "children": [
                            {
                                ...
                                "children": [
                                    ...
                                    //     "schedule_start_time_unix": 1599148800,
                                    //     "schedule_end_time_unix": 1599494399,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020-09-04 00:00:00",
                                    //     "end_time": "2020/9/9 23:59:59",
                                    //     "start_time_unix": 1599148800,
                                    //     "end_time_unix": 1599667199,
                                    //     "status": 106,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_start_time_unix": 1599494400,
                                    //     "schedule_end_time_unix": 1599839999,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/9/5 0:0:0",
                                    //     "end_time": "2020-09-11 23:59:59",
                                    //     "start_time_unix": 1599235200,
                                    //     "end_time_unix": 1599839999,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_end_time": "2020-09-15 23:59:59",
                                    //     "schedule_start_time_unix": 1599840000,
                                    //     "schedule_end_time_unix": 1600185599,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/9/10 0:0:0",
                                    //     "end_time": "2020/9/13 23:59:59",
                                    //     "start_time_unix": 1599667200,
                                    //     "end_time_unix": 1600012799,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_start_time_unix": 1600358399,
                                    //     "schedule_end_time_unix": 1600617599,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/9/15 00:00:00",
                                    //     "end_time": "2020-09-23 23:59:59",
                                    //     "start_time_unix": 1600128000,
                                    //     "end_time_unix": 1600876799,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_start_time_unix": 1600963200,
                                    //     "schedule_end_time_unix": 1601567999,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/9/28 0:0:0",
                                    //     "end_time": "2020/10/1 23:59:59",
                                    //     "start_time_unix": 1601222400,
                                    //     "end_time_unix": 1601567999,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_start_time_unix": 1601654400,
                                    //     "schedule_end_time_unix": 1602345599,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/10/5 0:0:0",
                                    //     "end_time": "2020/10/8 23:59:59",
                                    //     "start_time_unix": 1601827200,
                                    //     "end_time_unix": 1602172799,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    //     "schedule_start_time_unix": 1602518400,
                                    //     "schedule_end_time_unix": 1603209599,
                                    //     "create_user": 0,
                                    //     "create_user_name": "",
                                    //     "start_time": "2020/10/15 0:0:0",
                                    //     "end_time": "2020/10/23 23:59:59",
                                    //     "start_time_unix": 1602691200,
                                    //     "end_time_unix": 1603468799,
                                    //     "status": 201,
                                    //     "is_main_task": false,
                                    //     "cp_admin_name": [
                                    //         "饶饶乙方"
                                    ...
                                    // },
                                    {
                                        ...
                                        "schedule_start_time_unix": 1599235200,
                                        "schedule_end_time_unix": 1599321599,
                                        "create_user": 0,
                                        "create_user_name": "",
                                        "start_time": "2020/9/7 0:0:0",
                                        "end_time": "2020/9/30 23:59:59",
                                        "start_time_unix": 1599408000,
                                        "end_time_unix": 1601481599,
                                        "status": 106,
                                        "is_main_task": false,
                                        "cp_admin_name": [
                                            "饶饶乙方"
        ...
        methods: {
            ...
            initCanvas(dataArr,flag) {
                ...
                this.canvasWidth = this.dateTime.length * this.cellWidth;
                ...
                if (dateArrLength > 0) {
                    ...
                    for (let i = 0; i < dateArrLength; i++) {
                        ...
                        if (dateTime[i].weeks === 6 || dateTime[i].weeks === 0) {
                            ctx.fillStyle = _this.backGroundLight;
                    ...
                    if (taskData && taskData.length > 0) {
                        taskData.forEach(function (item, index, arr) {
                            ...
                            if(item.status === 110 || item.status === 209){
                                item.schedule_start_time_unix = item.start_time_unix;
                                item.schedule_end_time_unix = item.end_time_unix;
                            }
                ...
                return new Promise(function (reslove, reject) {
                    if (dataArr && dataArr.length > 0) {
                        dataArr.forEach(function (item) {
                            ...
                            if ('children' in item) {
                                tempsObj.isDelay = item.isDelay || null;
            ...
            calcTimeFrame(time,type){
                ...
                const lastDate = dateTime[dateLength - 1].end;//当前时间段最后一个时间
                let temp = null;
                if(type === 'start'){
                    if(time < firstDate){
                        temp = firstDate;
            ...
            calcAdvanceOrDelay(item) {
                ...
                const lastDate = dateTime[dateLength - 1].end;//当前时间段最后一个时间
                //计算任务开始、结束,提前、延期坐标
                if(Number(item.schedule_start_time_unix) < firstDate && Number(item.schedule_end_time_unix) < firstDate){
                    item.startX = 0;
                    item.endX = 0;
                    item.taskStartX = 0;
                    item.taskEndX = 0;
                }else if(Number(item.schedule_start_time_unix) > lastDate && Number(item.schedule_end_time_unix) > lastDate){
                    ...
                    item.startX = (this.findStartIndex(lastDate) + exceededStartDay) * this.cellWidth;
                    item.endX = (this.findStartIndex(lastDate) + exceededEndDay) * this.cellWidth;
                    item.taskStartX = 0;
                    item.taskEndX = 0;
                }else if(Number(item.schedule_start_time_unix) === Number(item.start_time_unix)){
                    //正常开始
                    item.startX = this.findStartIndex(Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) * this.cellWidth;
                    item.taskStartX = this.findStartIndex(Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) * this.cellWidth;
                    if(Number(item.schedule_end_time_unix) === Number(item.end_time_unix)){
                        //正常结束
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.schedule_start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.schedule_end_time_unix,'dateTime');
                    }else if(Number(item.end_time_unix) < Number(item.schedule_end_time_unix)){
                        //提前结束
                        item.stageType = 1;
                        item.stageTypeStr = '正常开始,提前结束';
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.advanceEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.end_time_unix,'end'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.schedule_start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.schedule_end_time_unix,'dateTime');
                    }else if(Number(item.end_time_unix) > Number(item.schedule_end_time_unix)){
                        //延期结束
                        ...
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.delayEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_end_time_unix,'end'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.schedule_start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.end_time_unix,'dateTime');
                    }
                }else if(Number(item.start_time_unix) < Number(item.schedule_start_time_unix)){
                    //提前开始
                    item.startX = this.findStartIndex(Number(this.calcTimeFrame(item.start_time_unix,'start'))) * this.cellWidth;
                    item.taskStartX = this.findStartIndex(Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) * this.cellWidth;
                    item.advanceStartX = Math.ceil((Number(this.calcTimeFrame(item.schedule_start_time_unix,'start')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                    if(Number(item.schedule_end_time_unix) === Number(item.end_time_unix)){
                        //正常结束
                        item.stageType = 3;
                        item.stageTypeStr = '提前开始,正常结束';
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.schedule_end_time_unix,'dateTime');
                    }else if(Number(item.end_time_unix) < Number(item.schedule_end_time_unix)){
                        //提前结束
                        item.stageType = 4;
                        ...
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.delayEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_end_time_unix,'end'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.end_time_unix,'dateTime');
                    ...
                    //延期开始
                    item.startX = this.findStartIndex(Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) * this.cellWidth;
                    item.taskStartX = this.findStartIndex(Number(this.calcTimeFrame(item.start_time_unix,'start'))) * this.cellWidth;
                    item.delayStartX = Math.ceil((Number(this.calcTimeFrame(item.start_time_unix,'start')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                    if(Number(item.schedule_end_time_unix) === Number(item.end_time_unix)){
                        //正常结束
                        item.stageType = 6;
                        item.stageTypeStr = '延期开始,正常结束';
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.schedule_start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.schedule_end_time_unix,'dateTime');
                    }else if(Number(item.end_time_unix) < Number(item.schedule_end_time_unix)){
                        //提前结束
                        ...
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                        item.advanceEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.end_time_unix,'end'))) / 86400) * this.cellWidth;
                        item.firstTime = this.coverDateTime(item.schedule_start_time_unix,'dateTime');
                        item.lastTime = this.coverDateTime(item.schedule_end_time_unix,'dateTime');
                    }else if(Number(item.end_time_unix) > Number(item.schedule_end_time_unix)){
                        ...
                        item.endX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_start_time_unix,'start'))) / 86400) * this.cellWidth;
                        //如果实际开始时间 大于排期结束时间
                        if(Number(item.start_time_unix) >= Number(item.schedule_end_time_unix)){
                            item.taskEndX = 0;
                            item.delayEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                        }else {
                            item.taskEndX = Math.ceil((Number(this.calcTimeFrame(item.schedule_end_time_unix,'end')) - Number(this.calcTimeFrame(item.start_time_unix,'start'))) / 86400) * this.cellWidth;
                            item.delayEndX = Math.ceil((Number(this.calcTimeFrame(item.end_time_unix,'end')) - Number(this.calcTimeFrame(item.schedule_end_time_unix,'end'))) / 86400) * this.cellWidth;
                        }
            ...
            drawAdvanceOrDelay(ctx, item) {
                ...
                if(item.status === 106 || item.status === 205 || item.isDelay){
                    rectFill = true;
                    rectStroke = true;
            ...
            gotoTask(task) {
                ...
                if(task.start_time_unix > lastDate){
